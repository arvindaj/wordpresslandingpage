            ...
            <div className="card border-0 h-100">
              ...
              <div className="card-body d-flex flex-column justify-content-between">
                ...
                <div className="bg-dark text-white text-center p-3 rounded-3 mt-3">
                  ...
                  <button className="badge btn mt-2 fs-6 text-center text-black bg-light">Join now</button>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="col-12 col-sm-6 col-md-4">
            <div className="card bg-dark text-white border-0 h-100">
              ...
              <div className="card-body position-relative" style={{ top: "10px" }}>
                 <span className="btn mb-lg-3 mt-lg-2" style={{
                          backgroundColor:'#8EC440'
                        }}>Custom Project</span>
                <h1 className="card-title mx-1 fs-1 mt-2">Create Your Custom Project</h1>
                <a
                  href="#"
                  className="text-white fw-semibold mt-lg-4 d-flex align-items-center fs-4 mx-2"
                >
                  Learn more
          ...
          <div className="col-12 col-md-5">
            <div className="card border-0 h-100 ">
              <div className="card-body bg-light mb-4 ">
                ...
                <a href="#" className=" text-black fs-5">Learn more <BsArrowUpCircle className="ms-2" /></a>
              </div>
              ...
              <div className='row g-3'>
                <div className='col-12 col-sm-6'>
                  <div className="card bg-dark text-white shadow-sm border-0 h-100">
                    <div className="card-body d-flex flex-column justify-content-between">
                      <div>
                        <span className="btn mb-2 mt-2 fs-6" style={{
                          backgroundColor:'#8EC440'
                     ...
                     <a
                  href="#"
                  className="text-white fw-semibold mb-4 d-flex align-items-center fs-4 mx-2"
                >
                  Learn more
                  <FaCheckCircle className="ms-2" style={{ color: '#8EC440' }} />
                </a>
